...
pub fn draw(f: &mut Frame, app: &App, area: Rect) {
    let lines = vec![
        ...
        "2 Technology path: Quick Ollama, low-resource llama.cpp, edge LiteRT, fine-tuned Unsloth, or manual.",
        "3 Backend selection: Ollama local judge / llama.cpp local judge / LiteRT edge judge / Unsloth fine-tuned judge / Manual endpoint.",
        "4 Hardware check: OS, CPU arch, RAM, GPU hints, disk, Ollama, llama.cpp, optional Kaggle CLI, free ports.",
        "5 Model picker: Gemma 4 E2B, Gemma 4 E4B, larger Gemma 4, fine-tuned Witness E2B/E4B, custom editable name/path.",
        "6 Install/pull/download: ollama pull, llama.cpp server URL, LiteRT path, Colab fine-tuned model path, manual URL/auth.",
