...
pub fn draw(f: &mut Frame, app: &App, area: Rect) {
    let lines = vec![
        ...
        "4 Hardware check: OS, CPU arch, RAM, GPU hints, disk, Ollama, llama.cpp, Kaggle CLI, free ports.",
        "5 Model picker: Gemma 4 E2B, Gemma 4 E4B, larger Gemma 4, fine-tuned Witness E2B/E4B, custom editable name/path.",
        "6 Install/pull/download: ollama pull, llama.cpp server URL, LiteRT path, Kaggle fine-tuned model, manual URL/auth.",
