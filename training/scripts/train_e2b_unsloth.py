...
BASE_MODEL=os.environ.get("BASE_MODEL") or os.environ.get("GEMMA4_E2B_BASE") or "google/gemma-4-e2b"
OUTPUT_DIR=Path(os.environ.get("OUTPUT_DIR","training/outputs/witness-gemma4-e2b-judge"))
