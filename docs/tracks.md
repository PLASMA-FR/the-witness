...
## Unsloth Track
The Witness includes real fine-tuning notebooks and scripts for Gemma 4 E2B/E4B Witness judge models. The TUI Model Manager lists fine-tuned models, the notebooks run on Google Colab, optional Kaggle scripts upload/download artifacts, and model tests verify JSON schema behavior.
