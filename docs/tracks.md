...
## Unsloth Track
The Witness includes real fine-tuning notebooks and scripts for Gemma 4 E2B/E4B Witness judge models. The TUI Model Manager lists fine-tuned models, Kaggle scripts upload/download them, and model tests verify JSON schema behavior.
